...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (result) {
                console.log('result', {
                    result: (_b = (_a = result === null || result === void 0 ? void 0 : result.data) === null || _a === void 0 ? void 0 : _a.files) === null || _b === void 0 ? void 0 : _b.filter((fileData) => langFiles.includes(fileData.filename)).map((fileData) => ({
