...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (commitDiff) {
                const messages = (_b = (_a = commitDiff === null || commitDiff === void 0 ? void 0 : commitDiff.data) === null || _a === void 0 ? void 0 : _a.files) === null || _b === void 0 ? void 0 : _b.filter((fileData) => langFiles.includes(fileData.filename)).map((fileData) => ({
                    fileName: fileData.filename,
                    messages: getMessages((fileData === null || fileData === void 0 ? void 0 : fileData.patch) || '')
                }));
                const messagesToPrint = (_c = messages === null || messages === void 0 ? void 0 : messages.filter(({ messages }) => {
                    return messages ? (messages === null || messages === void 0 ? void 0 : messages.length) > 0 : false;
                })) === null || _c === void 0 ? void 0 : _c.map(({ fileName, messages }) => {
                ...
                const comment = (_d = comments === null || comments === void 0 ? void 0 : comments.data) === null || _d === void 0 ? void 0 : _d.find((comment) => {
                    var _a;
